...
class GreetingMaker(object):
    def get_fortune(self, name):
        ...
        print("Receive request at:{}\nGoing to sleep for ten second".format(
            time2str()))
        ...
        return "Hi, {}, greeting from {}\nYour finish time:{}, magic num:{}".format(
            name, show(), time2str(), var_clone)
...
def run(ip_in_lan='100.100.100.1'):
    ...
    uri = daemon.register(
        GreetingMaker)  # register the greeting maker as a Pyro object
    ns.register("example.greeting",
